...
void CVideoWnd::OnContextvideoEdittransparency()
{
    ...
    {
        // int ret = MessageBox("Enabling Transparency at a high refresh rate will cause dialog boxes to freeze. If this
        // happens, you will have to close the Video Annotation window to make the dialog boxes appear. Reduce the
        // refresh rate ?" ,"Note",MB_YESNOCANCEL | MB_ICONQUESTION);
