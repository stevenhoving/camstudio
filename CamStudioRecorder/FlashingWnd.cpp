...
void CFlashingWnd::SetUpRegion(const CRect &cRect, int type)
{
    ...
    //    |  +--- rgnTemp--------------+  |
    //
    // wndRgn defines a new rect with the size of the requested area but something bigger because the border lines are
    // included either. rgnTemp relative points to the area with the size of the area off interrest but inside wndRgn
    // rgnTemp2 ??
    // rgnTemp3 ??
    //
    ///////////////////////////////////////////////////
    ...
    // m_cRect.right , m_cRect.top , m_cRect.bottom, m_cRect.Width(), m_cRect.Height() );
    ...
    else
    {
        ...
        rgnTemp.CreateRectRgn(SMALLTHICKNESS, SMALLTHICKNESS, m_cRect.Width() + SMALLTHICKNESS + 1,
                              m_cRect.Height() + SMALLTHICKNESS + 1);
