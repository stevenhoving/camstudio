...
void CKeyshortcutsDlg::DoDataExchange(CDataExchange *pDX)
{
    ...
    DDX_Control(pDX, IDC_CTRL7, m_ctrlButtonAutoSpanCTRL);
    DDX_Control(pDX, IDC_ALT7, m_ctrlButtonAutoSpanALT);
    DDX_Control(pDX, IDC_SHIFT7, m_ctrlButtonAutoSpanSHFT);
...
int CKeyshortcutsDlg::GetIndex(UINT keyShortCut)
{
    ...
    return static_cast<int>(iter - m_vKeyCode.begin());
}
