...
void CAudioMixer::OnError(MMRESULT uError, const TCHAR *lpszFunction /*= nullptr*/)
{
    ...
    switch (uError)
    {
        ...
        case MMSYSERR_BADDEVICEID:
            TRACE("The uMxId parameter specifies an invalid device identifier.\n");
            break;
        case MMSYSERR_NOTENABLED:
            TRACE("driver failed enable\n");
            break;
        case MMSYSERR_ALLOCATED:
            TRACE("The specified resource is already allocated by the maximum number of clients possible.\n");
            break;
        case MMSYSERR_INVALHANDLE:
            TRACE("The uMxId parameter specifies an invalid handle.\n");
            break;
        case MMSYSERR_NODRIVER:
            TRACE("No mixer device is available for the object specified by uMxId. Note that the location referenced "
                  "by uMxId will also contain the value  - 1.\n");
            break;
        case MMSYSERR_NOMEM:
            TRACE("Unable to allocate resources.\n");
            break;
        case MMSYSERR_NOTSUPPORTED:
            TRACE("function isn't supported\n");
            break;
        case MMSYSERR_BADERRNUM:
            TRACE("error value out of range\n");
            break;
        case MMSYSERR_INVALFLAG:
            TRACE("One or more flags are invalid.\n");
            break;
        case MMSYSERR_INVALPARAM:
            TRACE("One or more parameters are invalid.\n");
            break;
        case MMSYSERR_HANDLEBUSY:
            TRACE("handle being used simultaneously on another thread (eg callback)\n");
            break;
        case MMSYSERR_INVALIDALIAS:
            TRACE("specified alias not found\n");
            break;
        case MMSYSERR_BADDB:
            TRACE("bad registry database\n");
            break;
        case MMSYSERR_KEYNOTFOUND:
            TRACE("registry key not found\n");
            break;
        case MMSYSERR_READERROR:
            TRACE("registry read error\n");
            break;
        case MMSYSERR_WRITEERROR:
            TRACE("registry write error\n");
            break;
        case MMSYSERR_DELETEERROR:
            TRACE("registry delete error\n");
            break;
        case MMSYSERR_VALNOTFOUND:
            TRACE("registry value not found\n");
            break;
        case MMSYSERR_NODRIVERCB:
            TRACE("driver does not call DriverCallback\n");
            break;
        case MMSYSERR_MOREDATA:
            TRACE("more data to be returned\n");
            break;
        case MIXERR_INVALLINE:
            TRACE("The audio line reference is invalid.\n");
            break;
        case MIXERR_INVALCONTROL:
            TRACE("The control reference is invalid.\n");
            break;
        case MIXERR_INVALVALUE:
            TRACE("The parameter value is invalid.\n");
            break;
        default:
        {
