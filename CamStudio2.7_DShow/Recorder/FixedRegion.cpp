...
, m_iLeft(0)
, m_iTop(0)
, m_iWidth(::GetSystemMetrics(SM_CXVIRTUALSCREEN))
, m_iHeight(::GetSystemMetrics(SM_CYVIRTUALSCREEN))
{
...
void CFixedRegionDlg::OnOK()
{
	...
	//if(!::MoveWindow(hMouseCaptureWnd, m_iLeft, m_iTop, m_iWidth, m_iHeight, true))
		//MessageBox("Failed to create capture window!", "", 0);
	CDialog::OnOK();
}
