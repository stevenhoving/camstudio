...
void FlashActionVectorImporter::Import(N_STD::istream &in, N_STD::vector<FlashActionRecord *> &v,
                                       gc_vector<FlashActionRecord *> &d)
{
    int i;
    int count = 0;
...
void FlashActionVectorImporter::Import(N_STD::istream &in, N_STD::vector<FlashActionRecord *> &v,
                                       gc_vector<FlashActionRecord *> &d, UDWORD actionsBlockSize)
{
    int i;
    int count = 0;
