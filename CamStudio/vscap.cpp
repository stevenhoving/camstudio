...
/////////////////////////////////////////////////////////////////////////////
// CVscapApp
const char * CVscapApp::CAMSTUDIO_MUTEX = _T("VSCAP_CAB648E2_684F_4FF1_B574_9714ACAC6D57");
...
BOOL CVscapApp::FirstInstance()
{
	...
	if (!bPrevInstance) {
		OnError(_T("CVscapApp::FirstInstance"));
	...
	if (bPrevInstance) {
		...
		OnError(_T("CVscapApp::FirstInstance fails"));
...
bool CVscapApp::LoadLanguage(LANGID LangID)
{
...
bool CVscapApp::RegisterWindowClass()
{
	// todo: add mutex code
	WNDCLASS wndcls;
