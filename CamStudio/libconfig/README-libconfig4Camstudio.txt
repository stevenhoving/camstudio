...
>>  Last succesfully tested libconfig release: 1.4.6. <<
...
To be able to compile Camstudio you are adbvised to download and to use libconfig from:
...
File CamStudio.sln is prepared to work to gether with libconfig.
...
If you have build Camstudio succesfully with other libconfig releases just let us know.
