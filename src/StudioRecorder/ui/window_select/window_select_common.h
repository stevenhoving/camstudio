...
// Gets window ancestor (usually the window we want to do stuff with), filtering out all "non standard" windows like the
// taskbar, etc. and provide the app process path
